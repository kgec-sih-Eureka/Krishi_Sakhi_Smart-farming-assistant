...
export const DiseaseDetection = () => {
  ...
  <div className="bg-gray-50 min-h-screen flex items-center justify-center p-6">
    <div className="bg-white rounded-2xl shadow-xl max-w-5xl w-full p-8 mt-20 border border-gray-200">
      {/* Header */}
      ...
      <div className="text-center mb-8">
        ...
        <select
          ...
          className="px-5 py-2 rounded-lg border border-gray-300 text-gray-700 bg-white focus:ring-2 focus:ring-green-500 focus:outline-none transition"
        >
      ...
      <div className="flex flex-col lg:flex-row gap-6 mb-8">
        ...
        {/* Preview Section */}
        <div className="flex-1 min-w-0">
          <div className="bg-gray-100 rounded-xl min-h-72 flex items-center justify-center overflow-hidden border border-gray-200">
            {selectedImage ? (
              <img
                src={selectedImage}
                alt="Plant preview"
      ...
      <div className="text-center mb-8">
        <button
          ...
          className="bg-green-600 text-white px-8 py-3 rounded-lg text-lg font-medium shadow-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition"
        >
          {isAnalyzing ? (
