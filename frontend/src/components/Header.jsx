        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              <a href="#" className="text-green-900 hover:text-emerald-600 px-3 py-2 text-sm font-medium transition-colors">
                Home
              </a>
              <a href="#" className="text-green-700 hover:text-emerald-600 px-3 py-2 text-sm font-medium transition-colors">
                Explore
              </a>
              <a href="#" className="text-green-700 hover:text-emerald-600 px-3 py-2 text-sm font-medium transition-colors">
                Conservation
